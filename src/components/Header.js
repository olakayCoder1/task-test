...
function Header(props) {
  ...
  return (
    <div className=' w-full h-16 fixed top-0 bg-white z-50 px-4 lg:pl-0'>
      <div className=' w-full flex justify-between gap-16 items-center lg:px-3 pr-4 lg:pl-0 box-border'>
          ...
          <div className=' lg:grow h-full'>
            <form className='hidden lg:block lg:grow'>   
                ...
                <div className="relative">
                    ...
                    <input type="search" id="default-search" className="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300  outline-none focus:shadow-md focus:bg-white focus:border-gray-50 placeholder:text-xl placeholder:font-light placeholder:text-gray-300" placeholder="Search for podcasts" required />
                </div>
                </form>
          </div>
